...
**:one: Motivation for the user to make a shopping list and price consideration (3:40)**
...
> I usually don't look it up most of the time. It's like, is the thing that I want at that grocery store? You know I don't look at the prices and stuff, if it's available.
...
Coming into this project, I was excited about my idea to curate an app that compares prices for grocery products across different grocer locations. Due to my personal experience using the Ralph's App and Target App while shopping, I was surprised to learn that my participant had not engaged with one of these platforms before and does not frequently use the other platform. By asking questions about the user's own searches, I learned that not all individuals think as deeply about comparing prices or coupons. My participant primarily shops at Trader Joe's, which does not offer an app or rewards program, and so it was fascinating to learn about how the user organizes her shopping lists and overall shopping trips. However, my participant was helpful in expressing that she would be interested in using a platform such asthe one I described in order to save money and navigate grocery shopping trips with more ease. 

Overall, I enjoyed conducting this Contextual Inquiry with my participant, as I felt as though I was able to ask additional questions on the spot to clarify why the user did what they did during the tasks or why the user had certain preferences. In other words, I felt as though this interview style was more conversational than the Usability Testing task. I felt more comfortable during the interview process, and I think that my participant felt comfortable answering the questions I asked and completing the tasks in front of me. 

The participant's active description of what she was doing during each task allowed me to better understand the thought process of users when creating shopping lists, whether written or digital. Additionally, I enjoyed the feedback and values that the participant shared while using the Ralph's app, as this allowed me to think more about how to maximize the ease and efficiency of creating a digital shopping list for consumers to use across different grocery store locations.
