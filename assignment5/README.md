...
Overall, I think that this project went well, and I enjoyed creating the flow of my app. I accidentally added arrows to the flow that indicated my own thinking process before my participant conducted each task; however, I told her to focus on the pencil-drawn lines to see the general flow of the app. This may have made it more difficult for my participant to create their own flow through each task. Aside from this, my participant seemed to appreciate the layout of the home page in terms of being able to view their nearby stores, create a new list, or click through different main pages of the app. I tried to create a menu section at the bottom of the home page that highlighted the main features of the app, specifically helping users save money (i.e. with coupons) and try new things (i.e. recipes). 

Moreover, by doing this assignment, I learned that some of the tasks that I deemed to be self-explanatory may not be as easy or quick to figure out as I anticipated. I think that I should add a Frequently Asked Questions (FAQs) in the profile page, or include a simple tutorial when the user opens the app for the first time. The purpose of the app is to help users save time and money, and so I want the user to be able to understand and have easy access to all features. Based on my participant's feedback, I would change several aspects of the app layout, icons, and functionality, as discussed in the Test Scenarios section above. I have some concerns about the app appearing too complicated based on my user's actions and feedback, in which she seemed to try to complete each task in whatever way seemed to be the fastest. Going forward, I want to ensure that all the features of the app are identifiable, enabling users to take advantage of what the app can do without resorting to their old ways of writing their grocery list in their notes or on a piece of paper.
